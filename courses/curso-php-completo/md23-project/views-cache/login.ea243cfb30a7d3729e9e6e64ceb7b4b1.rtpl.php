    ...
    <div class="container">
        <div class="row">                
            <div class="col-md-6">
                ...
                <form action="/WebCourse/courses/curso-php-completo/md23-project/index.php/login" id="login-form-wrap" class="login" method="post">
                    <h2>Acessar</h2>
                    ...
                    <p class="lost_password">
                        <a href="/WebCourse/courses/curso-php-completo/md23-project/index.php/forgot">Esqueceu a senha?</a>
                    </p>
            ...
            <div class="col-md-6">
                ...
                <form id="register-form-wrap" action="/WebCourse/courses/curso-php-completo/md23-project/index.php/register" class="register" method="post">
                    <h2>Criar conta</h2>
                    <p class="form-row form-row-first">
