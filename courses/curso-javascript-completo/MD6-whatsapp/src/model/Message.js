        ...
        switch (this.type) {
                                ...
                                <div class="_3DZ69" role="button">
                                    ...
                                    <div class="_3a5-b">
                                        <div class="_1DZAH" role="button">
                                            <span class="message-time">${Format.timeStampToTime(Date.now())}</span>
            ...
            case 'audio':
                    ...
                    audioEl.ontimeupdate = e=>{
                        ...
                        inputRange.value = (audioDuration * 100) / this.duration;
            ...
            Message.upload(file, from).then(url=>{
                    ...
                    if (filePreview) {
                        ...
                        Message.upload(filePreview, from).then(url2=>{
                            ...
                            let downlaodPreview = url2;
    
                            msgRef.set({
                                content: downloadFile,
                                preview: downlaodPreview,
                                filename: file.name,
                                size: file.size,
                                fileType: file.type,
                                status: 'sent',
