...
export class WhatsAppController {
                ...
                div.innerHTML = `
                    ...
                    <div class="_3j7s9">
                        <div class="_2FBdJ">
                            ...
                            <div class="_3Bxar">
                                <span class="_3T2VG">${Format.toTime(contact.lastMessageTime)}</span>
                            </div>
                        </div>
                        <div class="_1AwDx">
                            <div class="_itDl">
    ...
    setActiveChat(contact){
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp').onSnapshot(docs =>{
            ...
            let autoScroll = (scrollTop >= scrollTopMax) ? true : false ;
            ...
            docs.forEach(doc=>{
                ...
                if(!me && this._messagesRecived.filter(id =>{ return (id === data.id) }).length === 0 ) { 
                    ...
                    this._messagesRecived.push(data.id);
    ...
    initEvents(){
        ...
        this.el.formPanelAddContact.on('submit', e=>{
            ...
            contact.on('datachange', data=>{
                if (data.name){
                    ...
                    console.error("Usuário não foi encontrador");
                }
            });
        ...
        this.el.btnEmojis.on('click', e=>{
            ...
            this.el.panelEmojis.toggle('open');
    ...
    closeRecordMicrophone() {
        ...
        this.el.btnSendMicrophone.show();
        clearInterval(this.el._recordMicrophoneInterval);
